...
export default function CardFeatured({ item }: CardFeaturedProps) {
  ...
  return (
    <Link
      ...
      className="flex flex-col items-center w-full p-1.5 rounded-[28px] border-[1.5px] hover:bg-white/10 transition-colors"
    >
      <Image
        src={image}
        alt=""
        width={512}
        height={512}
        className="rounded-[20px] mt-3 border-[1.5px] border-gray-200/20 object-cover"
      />
